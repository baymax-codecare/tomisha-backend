...
export class CreateTables1596363055683 implements MigrationInterface {
    name = 'CreateTables1596363055683'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user-companies" ("id" SERIAL NOT NULL, "companyId" uuid, "userId" uuid, "rights" smallint array, CONSTRAINT "PK_3e6ca6cdd4aeb52c7044506614a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8acb7cdbac6b1ab85c492475a3" ON "user-companies" ("companyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a24c234594d21925cdfc1441b0" ON "user-companies" ("userId") `);
        await queryRunner.query(`CREATE TABLE "companies" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "emailExpireAt" TIME, "slug" character varying NOT NULL, "status" smallint NOT NULL DEFAULT 1, "name" character varying(500), "cover" character varying(250), "picture" character varying(250), "slogan" character varying, "description" character varying, "website" character varying, "foundedAt" date, "size" smallint, "totalPermanents" smallint, "totalInterns" smallint, CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user-companies" ADD CONSTRAINT "FK_8acb7cdbac6b1ab85c492475a37" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user-companies" ADD CONSTRAINT "FK_a24c234594d21925cdfc1441b05" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user-companies" DROP CONSTRAINT "FK_a24c234594d21925cdfc1441b05"`);
        await queryRunner.query(`ALTER TABLE "user-companies" DROP CONSTRAINT "FK_8acb7cdbac6b1ab85c492475a37"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_a24c234594d21925cdfc1441b0"`);
        await queryRunner.query(`DROP INDEX "IDX_8acb7cdbac6b1ab85c492475a3"`);
        await queryRunner.query(`DROP TABLE "user-companies"`);
